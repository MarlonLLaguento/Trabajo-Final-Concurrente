...
// Maneja las solicitudes del maestro
func handle(con net.Conn, books []Book) {
	...
	case 2: // Recomendaciones basadas en géneros proporcionados
		...
		// Depuración: Verifica que los géneros se reciban correctamente
...
func active(books []Book) {
	ls, err := net.Listen("tcp", "0.0.0.0:9003")
	if err != nil {
	...
	fmt.Println("Trabajador escuchando en el puerto 9003...")
